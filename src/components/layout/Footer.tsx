      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <p className="text-text-muted text-xs font-light leading-relaxed max-w-xs">
              ספרות יוקרתית וקורס מקצועי לספרים שרוצים להגיע לרמה הבאה.
            </p>
        ...
        <div className="pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 text-text-muted text-[10px] tracking-[2px] uppercase">
          <p>© {year} {SITE_CONFIG.name}. כל הזכויות שמורות.</p>
          <p>Made in Israel</p>
        </div>
      </div>
    </footer>
